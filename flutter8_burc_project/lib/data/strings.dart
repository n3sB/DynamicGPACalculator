class Strings {
  ...
  static const List<String> BURC_GENEL_OZELLIKLERI = [
    ...
    "\t Genel Özellikler\n\n"
        ...
        "\t Grubunuz: Su\n\n"
        "\t Gamzem bu burçtan ve onu çok seviyorum. Bir akrep kadını olarak çok seksi şehvetli ateşli ve çok güzel\n\n"
        "\t En sevdiğim burç akreptir ve akreplerden de Gamzem\n\n"
        "\t Uğurlu gününüz: Salı\n\n"
        "\t Uğurlu sayınız: 9\n\n"
